...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            this_turn0 = take_turn(num0, score1, dice)
            score0 += this_turn0
            if feral_hogs and abs(num0 - last_turn0) == 2:
                score0 += 3
            ...
            this_turn1 = take_turn(num1, score0, dice)
            score1 += this_turn1
            if feral_hogs and abs(num1 - last_turn1) == 2:
                score1 += 3
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    res = [averaged(i + 1, dice) for i in range(10)]
...
def swap_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    _ = free_bacon(opponent_score)
    if is_swap(score + _, opponent_score):
        if opponent_score > score + _:
            return 0
        return num_rolls
    else:
        if _ >= cutoff:
