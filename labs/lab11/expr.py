...
class Name(Expr):
    ...
    def eval(self, env):
        ...
        # else:
        #     raise NameError("Name {} is not defined".format(self.var_name))
        return None
...
class CallExpr(Expr):
    ...
    def eval(self, env):
        ...
        if operator not in env:
            raise NameError("Operator {} is not difined".format(self.operator))
        operands = []
        for o in self.operands:
            operands.append(o.eval(env))
